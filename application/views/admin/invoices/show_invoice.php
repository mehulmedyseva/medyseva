		...
		<table style="width: 40%;margin-right: 0;margin-left: auto; font-size: 14px;margin-top: 20px;border-collapse: collapse;">
			<tbody>
				<tr>
					...
					<td style="padding: 5px;"><b><?php if(empty($amp->amount)){
                                   echo 'Rs '. ($amp->price+$final_amount);}else{ echo 'Rs '. ($amp->amount+$final_amount);} ?></b></td>
				</tr>
				<!--<tr>
				...
				<tr>
					...
					<td style="padding: 5px;"><b><?php   
					 ...
					 if(empty($amp->amount)){
                        ...
                        $amount = ($amp->price+$final_amount);}else{ $amount = ($amp->amount+$final_amount);} 
