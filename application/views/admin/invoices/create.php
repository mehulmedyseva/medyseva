            ...
            <main>
                <div class="row contacts">
                    <div class="col invoice-to">
                        ...
                        <h2 class="to"><?php echo html_escape($amp->name) ?></h2>
                        <div class="address"><?php echo html_escape($amp->mobile) ?></div>
                        <div class="email"><a href="mailto:john@example.com"><?php echo html_escape($amp->email) ?></a></div>
                    </div>
                    <div class="col col-sm-4 invoice-details">
                        <h1 class="invoice-id">INVOICE <?php echo$amp->id;  ?></h1>
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="unit">Rs <?php if(empty($amp->amount)){
                                   echo$amp->price;}else{ echo$amp->amount;} ?></td>
                            <td class="qty">0.00</td>
                            <td class="total">Rs  <?php if(empty($amp->amount)){
                                   echo$amp->price;}else{ echo$amp->amount;} ?></td>
                        </tr>
                       <!-- <tr>
                            <td class="no">01</td>
