<div class="content-wrapper">
  ...
  <section class="content container">
      ...
      <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
          <?php if (isset($page_title) && $page_title == "Edit"): ?>
            ...
            <a href="" class="pull-right btn btn-success btn-sm csv_btn"><i class="fa fa-file-excel-o" aria-hidden="true"></i>Import</a>
          <?php else: ?>
    ...
    <div id="import_exp" class="pull-right btn btn-secondary btn-sm csv_btn" style="display:none;">
          <form method="post" action="<?php echo base_url('admin/import_file/add_advise_investigations')?>" role="form" novalidate enctype="multipart/form-data">
          <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">
                  ...
                  <?php $i=1; foreach ($advise_investigations as $advise_investigation): ?>
                    <tr id="row_<?php echo html_escape($advise_investigation->id); ?>">
                        ...
                        <td><?php echo character_limiter($advise_investigation->details, 80); ?></td>
                         <td><?php echo$advise_investigation->price; ?></td>
...
document.querySelector("#csvdata").addEventListener("click", function () {
	...
	export_table_to_csv(html, "investigation.csv");
});
