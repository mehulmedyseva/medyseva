                ...
                <tbody>
                  <?php $i=1; foreach ($language as $lang): ?>
                    <tr class="tr-phrase">
                      ...
                      <td style="width: 20%;"><input type="text" class="form-control bg-g" value="<?php echo html_escape($lang->label) ?>" readonly></td>
                      <td style="width: 30%;"><input type="text" class="form-control bg-g" value="<?php echo html_escape($lang->keyword) ?>" readonly></td>
                      <td style="width: 40%;" <?php if($value == 'arabic'){echo "dir='rtl'";} ?>><input type="text" name="value<?php echo html_escape($lang->id) ?>" class="form-control" value="<?php echo html_escape($lang->$value) ?>"></td>
                    </tr>
                  <?php $i++; endforeach ?>
