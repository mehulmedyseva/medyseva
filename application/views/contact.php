                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="mobile" placeholder="Your name">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 mb-2">
                            ...
                            <div class="form-group mb-1">
                                <textarea name="message" id="message" rows="6" class="form-control" placeholder="Write more details" required></textarea>
                            </div>
                        </div>
                    </div>
